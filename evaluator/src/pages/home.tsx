            ...
            {!evaluationData || evaluationData.length === 0 ? (
                ...
                <div className="space-y-3">
                    {evaluationData.map((evaluation, index) => (
                        <div key={index} className="p-4 border rounded-md bg-muted/50 hover:bg-muted transition-colors cursor-pointer">
                            <div className="flex items-center justify-between mb-2">
                                <p className="text-sm font-semibold">{evaluation.date || 'Evaluation'}</p>
                            ...
                            <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                                ...
                                <span>{evaluation?.pendingRateesCount} member(s) to evaluate</span>
                            </div>
                        </div>
                    ))}
                </div>
