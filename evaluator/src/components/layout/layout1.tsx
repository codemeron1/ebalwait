                                ...
                                <div className="relative h-full flex flex-col">
                                    ...
                                    <div className="flex-1 bg-slate-50 rounded-none md:rounded-lg shadow-2xl 
                                        ...
                                        <div className="relative flex-1 flex flex-col bg-white">
                                            ...
                                            {/* Status Bar */}
                                            <div className="fixed bottom-0 left-0 right-0 bg-slate-200 border-t border-slate-300 px-4 py-2 flex items-center justify-between text-xs text-slate-600">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    {/* <span>Team: {userData?.team?.length || '0'}</span> */}
